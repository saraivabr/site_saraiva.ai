    ...
    <footer className="border-t border-border/50 py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Explorar */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-3 font-display">Explorar</h4>
          ...
          {/* Categorias */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-3 font-display">Categorias</h4>
            <div className="flex flex-col gap-2 text-sm">
          ...
          {/* Contato */}
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-3 font-display">Contato</h4>
            <div className="flex flex-col gap-2 text-sm">
              <a
